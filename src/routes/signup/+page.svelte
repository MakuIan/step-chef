...
{#snippet socialLoginIcon(provider: string)}
	{#if provider === 'google'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-2 h-4 w-4">
			...
			/>
			<path
				d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 6.13l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
				fill="#EA4335"
			/>
		</svg>
	{:else if provider === 'facebook'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-2 h-4 w-4" fill="#1877F2">
			<path
		...
		<Card.Content class="space-y-4">
			...
			<Card.Footer>
				<p class="text-sm text-muted-foreground">
					{m['auth.to_sign_in']()}
					<a href={localizeHref('/login')} class="font-medium text-primary hover:underline">
						Sign in
					</a>
				</p>
			</Card.Footer>
